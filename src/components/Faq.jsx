        ...
        <section className='py-5 position-relative'id='faq'>
                ...
                <div className='d-flex justify-content-center' data-aos="zoom-in" data-aos-duration="1500">
                    <Accordion defaultActiveKey="0" className='width-856'>
                        <Accordion.Item eventKey="1" className='w-100 bg-transparent'>
                            ...
                            <Accordion.Body className='fs_sm fw-normal ff_rubik opacity_08'>
            ...
            <div className='px-4 get_start_abs w-100'>
                <div className="my_container bg_btn py-5 rounded-4" data-aos="fade-down" data-aos-duration="2000">
                    ...
                    <p className='text-center ff_rubik fs_sm fw-normal text_ffffff mb-4 pb-3 opacity_09'> Our CV builder not only provides a user-friendly interface but also offers valuable <span className='d-md-block'>guidance along the way.</span></p>
