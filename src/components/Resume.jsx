                ...
                <div className="my_container my-md-5 py-md-1">
                    <Row>
                        <Col md={7}>
                            ...
                            <p data-aos="fade-right" data-aos-duration="1500" data-aos-delay="200" className='paragraphs mb-4'>Express your professional history without limitations or worry about how your resume looks</p>
                            <div data-aos="fade-right" data-aos-duration="1500" data-aos-delay="400" className='d-flex align-items-center mb-3'>
                                ...
                                <p className='paragraphs mb-0'> Professional sections like <strong className='fw-semibold'>Experience, Skills, Summary </strong> and <strong className='fw-semibold'>Education</strong></p>
                            </div>
                            <div data-aos="fade-right" data-aos-duration="1500" data-aos-delay="600" className='d-flex align-items-center mb-3'>
                                <span className='me-2 pe-1'><img src={check_icon} alt="check_icon" /></span>
                                <p className='paragraphs mb-0'> Professional sections like <strong className='fw-semibold'>Strengths, Quotes, Books, Interests</strong> and <strong className='fw-semibold'>My Time.</strong></p>
                            </div>
                            <div data-aos="fade-right" data-aos-duration="1500" data-aos-delay="800" className='d-flex mb-3 pb-4'>
                                <span className='me-2 pe-1'><img src={check_icon} alt="check_icon" /></span>
                                <p className='paragraphs mb-0'> Other sections like <strong className='fw-semibold'>Certifications, Awards, Achievements, Language</strong> and <strong className='fw-semibold'>Reference</strong></p>
                            </div>
                            <div data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1000"><button className='buttons bg_btn text_ffffff'>Get Started</button></div>
                        </Col>
                        <Col md={5} className='d-flex align-items-center position-relative z-1' data-aos="zoom-in" data-aos-duration="1500">
            ...
            <div className="my_container py-5 my-md-5 position-relative">
                ...
                <Row className='align-items-center py-md-5 my-md-3'>
                    ...
                    <Col md={6}>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1500" data-aos-delay="200" className='paragraphs mb-3'>Quickly ensure that your resume covers key skills and experience by pasting the job ad you’re applying for</p>
                        <div data-aos="fade-left" data-aos-duration="1500" data-aos-delay="400" className='d-flex align-items-center mb-3'>
                            <span className='me-2 pe-1'><img src={check_icon} alt="check_icon" /></span>
                            <p className='paragraphs mb-0'>Skills and experience analysis</p>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="1500" data-aos-delay="600" className='d-flex align-items-center mb-3'>
                            <span className='me-2 pe-1'><img src={check_icon} alt="check_icon" /></span>
                            <p className='paragraphs mb-0'>Actionable Checklist of what else to add to your resume</p>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="1500" data-aos-delay="800" className='d-flex align-items-center'>
                            <span className='me-2 pe-1'><img src={check_icon} alt="check_icon" /></span>
                            <p className='paragraphs mb-0'>Instant comparison between your resume and the job posting</p>
                        </div>
                    </Col>
                </Row>
            </div>
