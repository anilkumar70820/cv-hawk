                ...
                <Row className='py-md-3'>
                    ...
                    <Col lg={6}>
                        <Slider {...settings} className='mb-5 pb-3 resume_template z-1'>
                            <div data-aos="fade-down" data-aos-duration="1500" className='d-flex justify-content-center'>
                            ...
                            <div data-aos="fade-down" data-aos-duration="1500" data-aos-delay="400" className='d-flex justify-content-center'>
                                <div className='settings_card my-4 d-flex justify-content-center align-items-center flex-column'>
                            ...
                            <div data-aos="fade-down" data-aos-duration="1500" data-aos-delay="600" className='d-flex justify-content-center'>
                                <div className='settings_card my-4 d-flex justify-content-center align-items-center flex-column'>
                            ...
                            <div data-aos="fade-down" data-aos-duration="1500" data-aos-delay="800" className='d-flex justify-content-center'>
                                <div className='settings_card my-4 d-flex justify-content-center align-items-center flex-column'>
                            ...
                            <div data-aos="fade-down" data-aos-duration="1500" data-aos-delay="1000" className='d-flex justify-content-center'>
                                <div className='settings_card my-4 d-flex justify-content-center align-items-center flex-column'>
                        ...
                        <p data-aos="zoom-in" data-aos-duration="1500" className="paragraphs opacity-75">Theme's robust features allow you to showcase your skills, accomplishments, and experiences in a captivating way. From customizing the layout to selecting the perfect color scheme, every detail can be tailored to match your style and industry. </p>
                    </Col>
                </Row>
            </div>
        </section>
